...
<html lang="en">
  <head>
    ...
    <title>BibliGestion - Accueil</title>
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  <a class="navbar-brand" href="../index.php">BibliGestion</a>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="../genre/listeGenre.php">Liste des genres</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="../nationalite/listeNationalite.php">Liste des nationalités</a>
          <a class="dropdown-item" href="../nationalite/formNationalite.php?action=Ajouter">Ajouter un nationalité</a>
        </div>
      </li>
    </ul>
